...
public class ExpenseServiceTest {
	...
	public void setUp() {
		...
		BDDMockito.when(expenseRepository.findAllByUserId(65)).thenReturn(new ArrayList<Expense>());
	}
	...
	public void testGetAll() {
		BDDMockito.when(expenseService.getAll(65)).thenReturn(new ArrayList<Expense>());
	}
